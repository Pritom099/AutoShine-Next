...
const Footer = () => {
    return (
        <footer className="bg-purple-500/20 text-white py-8">
            <div className="container mx-auto px-4 flex flex-col items-center gap-5">

                {/* Footer Links */}
                <nav className="flex flex-wrap justify-center gap-6 font-semibold text-base">
                    ...
                    <a href="/press-kit" className="link link-hover">
                        Press Kit
                    </a>
                </nav>
