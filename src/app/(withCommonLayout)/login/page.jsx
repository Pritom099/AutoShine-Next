      ...
      <div className="relative hidden w-1/2 overflow-hidden bg-slate-900 lg:block">
        ...
        <div className="relative flex h-full flex-col justify-between p-12 text-white">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">AutoShine</span>
          </div>
          ...
          <div>
            <h1 className="text-4xl font-bold leading-tight">
              Your car deserves
              <br />
              <span className="text-amber-400">a perfect shine</span>
            </h1>
            <p className="mt-4 max-w-md text-slate-300">
              Sign in to book premium washes, ceramic coatings, and complete
              detailing services.
            </p>
          </div>
      ...
      <div className="flex w-full flex-col justify-center px-6 py-12 sm:px-12 lg:w-1/2 lg:px-16 xl:px-24">
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mb-8 flex items-center gap-2 lg:hidden">
            ...
            <span className="text-lg font-bold text-slate-900">AutoShine</span>
          </div>
          ...
          <button
            ...
            className="mt-8 flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
          >
            {isGoogleLoading ? (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pl-10 pr-11 text-sm text-slate-900 outline-none transition focus:border-slate-400 focus:bg-white focus:ring-2 focus:ring-slate-100"
                />
                <button
                  type="button"
